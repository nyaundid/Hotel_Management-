	...
	public LinkedList<Member> readFile(){
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("members.csv")))
        {
            ...
            while (lineRead != null)
            {
                ...
                {
                    mem = new SilverMember('S', Integer.parseInt(splitLine[1]), splitLine[2], Double.parseDouble(splitLine[3]));
                }else
                {
                    mem = new GoldMember('G', Integer.parseInt(splitLine[1]), splitLine[2], Double.parseDouble(splitLine[3]));                  
                }
